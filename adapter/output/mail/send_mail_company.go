...
func SendEmailCompany(contact response.ContactResponse) {
	from := os.Getenv("MAIL_AUTH_USER")
	password := os.Getenv("MAIL_AUTH_PASS")
	smtpHost := os.Getenv("MAIL_HOST")
	smtpPort := os.Getenv("MAIL_PORT")
	t, err := template.ParseFiles("./template/interprise_email.html")
	if err != nil {
	...
	subject := os.Getenv("TEXT_MAIL_TITLE_COMPANY")
